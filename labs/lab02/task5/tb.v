// tb.v
// Self-checking testbench for Task 5 ALUmodule tb;reg  [3:0] t_a, t_b;
reg        t_op;
wire [3:0] t_result;reg  [3:0] exp_result;
integer    errors = 0;
integer    total = 0;
integer    i, j, k;// Instantiate DUT
alu DUT (
.a(t_a),
.b(t_b),
.op(t_op),
...
t_a  = 0;
t_b  = 0;
t_op = 0;// 1. Check all operand & operation combinations
